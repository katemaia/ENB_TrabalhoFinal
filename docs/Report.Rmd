...
Para estudar a estrutura da rede de rotas rodoviárias de Minas Gerais, escolhi a métrica modularidade, que identifica a presença de módulos: grupos de microrregiões que são mais conectadas entre si do que com regiões de outros módulos.
